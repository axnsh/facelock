...
export default function Failure({ onTryAgain, onGoBack }: Props) {
  return (
    <div className="flex-1 flex flex-col items-center justify-center">

      <div className="w-[500px] h-[320px] bg-red-500 rounded" />

      <h2 className="mt-5 text-red-400 text-3xl font-bold">
        Access Denied
      </h2>
